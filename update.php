<?php
	...
	$sql = "UPDATE usuarios SET nomeUsuario = ?, emailUsuario = ?, ruaUsuario = ?, bairroUsuario = ?, cidadeUsuario = ?, compUsuario = ?, telUsuario = ?, senhaUsuario = ? WHERE idUsuario = ?";
	
	$consulta = $con->prepare($sql);
	//var_dump($con->error);
	$consulta->bind_param("sssssssss", $nome, $email, $rua, $bairro, $cidade, $complemento, $telefone, $senha, $id);
	$consulta->execute();
